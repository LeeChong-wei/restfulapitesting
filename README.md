...
![img](file:///C:/Users/yang/AppData/Local/Temp/msohtmlclip1/01/clip_image001.png) 
...
| weight   |                  |                  |              |                            |                                                              |
| 序号     | 数据元名称       | 数据元标识       | 数据元格式   | 数据元取值示例             | 备注                                                         |
| 1        | 依赖字段         | dependency_field | list<string> | ["project_id","branch_id"] |                                                              |
...
l 通过依赖关系矩阵和权重表，可视化展示数据关系。

l 可视化展示代码覆盖率等测试指标（TODO）

l 可视化展示测试结果，BUG信息（TODO）

l 可视化展示测试用例池相关信息（TODO）
